...
Claude's Grand Pattern implementation — Fibonacci dual-direction, dual-DB JEPA, double-entry vectorized
...
```bash
git clone https://github.com/SuperInstance/grand-pattern-claude
cd grand-pattern-claude
```
